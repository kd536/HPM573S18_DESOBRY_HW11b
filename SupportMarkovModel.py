...
def draw_survival_curves_and_histograms(simOutputs_none, simOutputs_anticoag):
    ...
    :param simOutputs_mono: output of a cohort simulated under none therapy
    ...
    PathCls.graph_sample_paths(
        ...
        legends=['None Therapy', 'Anticoag Therapy']
    )
    ...
    Figs.graph_histograms(
        ...
        y_label='Counts',
        bin_width=1,
        legend=['None Therapy', 'Anticoag Therapy'],
        transparency=0.6
    )
...
def print_comparative_outcomes(simOutputs_none, simOutputs_anticoag):
    ...
    under anticoag therapy compared to none therapy
    ...
    # increase in survival time under anticoag therapy with respect to none therapy
    if Settings.PSA_ON:
    ...
    # increase in discounted total cost under anticoag therapy with respect to none therapy
    if Settings.PSA_ON:
    ...
    # increase in discounted total utility under anticoag therapy with respect to none therapy
    if Settings.PSA_ON:
